...
export function Navbar() {
  ...
  return (
    <header
      ref={fixedNavRef}
      className="mx-auto flex w-full  items-center justify-between bg-gray-900 px-10 py-7 "
    >
        ...
        >
          <ul className="flex h-full w-full flex-row justify-between gap-6 lg:flex-row lg:justify-start lg:gap-1">
            <li className="flex items-center justify-center px-2 py-0.5">
              <a
                href="#"
                className="flex lg:hidden h-full w-full items-center justify-center"
              >
                <Image src="/logo.svg" alt="Logo" width={100} height={200} />
              </a>
            </li>
            <li className="hidden items-center justify-center px-2 py-0.5 lg:flex text-[#CACD38]">
                ...
                <AnimatePresence>
                  {active && (
                    <motion.a
                      ...
                      className="relative inline-flex w-fit shrink-0 items-center justify-center gap-x-1.5 overflow-hidden whitespace-nowrap rounded-full bg-[#CACD38] px-3 py-1.5 text-gray-900 outline-none dark:bg-white dark:text-black"
                    >
                      Get Started
                    </motion.a>
                  )}
      ...
      {/* <a className="relative hidden w-fit items-center justify-center gap-x-1.5 overflow-hidden rounded-full bg-[#CACD38] px-3 py-1.5 text-white outline-none dark:bg-white dark:text-black lg:inline-flex">
        Get Started
      </a> */}
    </header>
  );
